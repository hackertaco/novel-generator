...
**주어 명시 4대 규칙**:
1. **대사 연속 후 주어 명시**: 대사가 2줄 이상 연속된 뒤 첫 서술문에는 반드시 캐릭터의 풀네임을 주어로 쓴다. "그는/그녀는"으로 대체하지 마라.
   ❌ "…" / "…" / 고개를 돌렸다. (누가?)
   ✅ "…" / "…" / 카시안이 고개를 돌렸다.

2. **다인 장면 대명사 금지**: 씬에 3명 이상의 캐릭터가 등장하면 "그/그녀/그는/그녀는"을 절대 사용하지 마라. 반드시 이름을 쓴다.
   ❌ "그녀가 검을 들었다." (리아나? 세라? 누구?)
   ✅ "리아나가 검을 들었다."

3. **모든 문단 주어 필수**: 모든 문단의 첫 문장에는 반드시 문법적 주어가 있어야 한다. 주어 없이 동사로 시작하지 마라.
   ❌ "천천히 다가갔다." (누가?)
   ✅ "리아나가 천천히 다가갔다."

4. **대명사 사용 조건**: "그녀는/그는"은 해당 성별의 캐릭터가 씬에 정확히 1명일 때만 허용된다. 2명 이상이면 반드시 이름을 쓴다.
   ❌ (여성 2명인 장면) "그녀는 문을 닫았다."
   ✅ (여성 1명인 장면) "그녀는 문을 닫았다." — 허용
   ✅ (여성 2명인 장면) "세라가 문을 닫았다." — 이름 사용`,
    evaluatorKey: "comprehensibility",
    penalty: 0.1,
    repairInstruction: "독해 명확성을 높이세요. 주어 생략을 줄이고, 대명사를 구체적 이름으로 바꾸세요. 대사 연속 후 반드시 풀네임 주어를 쓰세요. 3인 이상 장면에서 대명사를 이름으로 교체하세요.",
  },
  curiosityGap: {
    id: "curiosity_gap",
    description: "호기심 유발",
